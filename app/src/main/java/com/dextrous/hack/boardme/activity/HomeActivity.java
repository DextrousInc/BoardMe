...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // API call 2
        Call<BoardRouteResponse> boardMeCall = apiService.getBoardingRouteData("jdksfh3423479231dsd", "1", "13.0242", "80.213");
        boardMeCall.enqueue(new BoardRouteResponseCallback());
